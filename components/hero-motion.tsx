...
export default function HeroMotion() {
  ...
  const rotate = useTransform(mx, (v) => v * 2)
  const translateY = useTransform(my, (v) => v * -6)
  ...
  return (
    <section className="relative w-full h-[88dvh] overflow-hidden">
      ...
      <div className="relative h-full flex items-center justify-center px-6">
        <motion.div className="text-center max-w-3xl" style={{ rotate, y: translateY }}>
          <p className="text-sm md:text-base text-muted-foreground tracking-widest uppercase">cireon.dev</p>
